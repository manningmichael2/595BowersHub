...
/** Switch over Radix (R2.2): accessible toggle, tokenized on/off states. */
...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        'pointer-events-none block h-5 w-5 rounded-full bg-surface shadow-elevation-1 transition-transform duration-fast',
