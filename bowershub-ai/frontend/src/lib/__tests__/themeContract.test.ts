...
const PRESETS: Record<string, Record<string, string>> = {
  'dark-navy': { background: '#0f0f1a', surface: '#1a1a2e', primary: '#6366f1', accent: '#818cf8', text: '#e5e7eb', text_muted: '#94a3b8', border: '#374151', danger: '#ef4444', success: '#22c55e', warning: '#eab308', error: '#ef4444' },
  ...
  'oled-black': { background: '#000000', surface: '#0a0a0a', primary: '#6366f1', accent: '#818cf8', text: '#fafafa', text_muted: '#a1a1aa', border: '#18181b', danger: '#ef4444', success: '#22c55e', warning: '#eab308', error: '#ef4444' },
